...
@interface TransformDescViewController ()

@property (nonatomic, strong)UITextView *textView;

@end

@implementation TransformDescViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = NSLocalizedString(@"Help_yunshu", nil);
    [self setupUI];
    [self loadData];
}
...
- (void)loadData {
    NSDictionary *dict = [NSDictionary requestWithUrl:@"business" param:@{@"type":@6}];
